...
async function generarContratoDocx(tenant, arrendador, direccionVivienda, plantillaBytes) {
  ...
  const bytes = plantillaBytes || base64ToUint8Array(CONTRATO_TEMPLATE_B64);
...
/* ---------------------------------------------------------------------
   ...
   Pensados para que, nada más entrar, se vea de un vistazo todo lo que
   ofrece Susalquia: habitaciones sueltas y viviendas completas a la vez,
   una subida de renta que no afecta a los meses pasados, incidencias en
   los tres estados posibles, y los datos del arrendador ya rellenados
   para poder generar un contrato al momento.
--------------------------------------------------------------------- */
const DEMO_MONTH = "2026-08";

function buildDemoRoomLabels() {
  return ["A1", "A2", "B1", "B2", "Piso Malecón", "Piso Ronda Sur"];
}

function buildDemoTenants() {
  const pagosCompletos = (meses) => {
    const o = {};
    meses.forEach(m => { o[m] = true; });
    return o;
  };
  return [
    // Habitación A1: inquilina activa, todo al día, empadronada
    {
      id: "demo-a1", habitacion: "A1", vivienda: "",
      nombre: "María", apellidos: "Fernández López", tipoDocumento: "DNI", numeroDocumento: "45123456B",
      nacionalidad: "Española", telefono: "611222333", correo: "maria.fernandez@example.com",
      fechaInicio: "2026-01-10", fechaFin: "2027-01-10", renovado: false, nuevaFechaFin: "",
      empadronado: true, renta: 350, fianzaImporte: 350, fechaPagoFianza: "2026-01-10", fechaDevolucionFianza: "",
      observaciones: "", activo: true,
      pagos: pagosCompletos(["2026-01","2026-02","2026-03","2026-04","2026-05","2026-06","2026-07","2026-08"]),
      documentosContrato: [], documentosIdentidad: [],
    },
    // Habitación A2: con el pago de este mes sin marcar, para que se vea una alerta real
    {
      id: "demo-a2", habitacion: "A2", vivienda: "",
      nombre: "Javier", apellidos: "Ortiz Ramos", tipoDocumento: "DNI", numeroDocumento: "50987654C",
      nacionalidad: "Española", telefono: "622333444", correo: "javier.ortiz@example.com",
      fechaInicio: "2026-03-01", fechaFin: "2026-09-01", renovado: false, nuevaFechaFin: "",
      empadronado: false, renta: 340, fianzaImporte: 340, fechaPagoFianza: "2026-03-01", fechaDevolucionFianza: "",
      observaciones: "Contrato termina pronto — pendiente de saber si renueva.", activo: true,
      pagos: pagosCompletos(["2026-03","2026-04","2026-05","2026-06","2026-07"]),
      documentosContrato: [], documentosIdentidad: [],
    },
    // Habitación B2: subida de renta a mitad de año — para enseñar el historial de renta
    {
      id: "demo-b2", habitacion: "B2", vivienda: "",
      nombre: "Laura", apellidos: "Gómez Ibáñez", tipoDocumento: "DNI", numeroDocumento: "48765432D",
      nacionalidad: "Española", telefono: "633444555", correo: "laura.gomez@example.com",
      fechaInicio: "2026-01-15", fechaFin: "2027-01-15", renovado: false, nuevaFechaFin: "",
      empadronado: true, renta: 410, fianzaImporte: 380, fechaPagoFianza: "2026-01-15", fechaDevolucionFianza: "",
      observaciones: "", activo: true,
      pagos: pagosCompletos(["2026-01","2026-02","2026-03","2026-04","2026-05","2026-06","2026-07","2026-08"]),
      documentosContrato: [], documentosIdentidad: [],
      historialRenta: [{ desde: "2026-01", importe: 380 }, { desde: "2026-06", importe: 410 }],
    },
    // Piso Malecón: vivienda completa, todo al día
    {
      id: "demo-malecon", habitacion: "Piso Malecón", vivienda: "Piso Malecón",
      nombre: "Roberto", apellidos: "Sánchez Peña", tipoDocumento: "DNI", numeroDocumento: "52345678E",
      nacionalidad: "Española", telefono: "644555666", correo: "roberto.sanchez@example.com",
      fechaInicio: "2026-02-01", fechaFin: "2027-02-01", renovado: false, nuevaFechaFin: "",
      empadronado: true, renta: 750, fianzaImporte: 750, fechaPagoFianza: "2026-02-01", fechaDevolucionFianza: "",
      observaciones: "", activo: true,
      pagos: pagosCompletos(["2026-02","2026-03","2026-04","2026-05","2026-06","2026-07","2026-08"]),
      documentosContrato: [], documentosIdentidad: [],
    },
    // Piso Ronda Sur: otra vivienda completa, para comparar rentabilidad entre las dos
    {
      id: "demo-ronda", habitacion: "Piso Ronda Sur", vivienda: "Piso Ronda Sur",
      nombre: "Elena", apellidos: "Ruiz Castaño", tipoDocumento: "NIE", numeroDocumento: "Y1234567L",
      nacionalidad: "Italiana", telefono: "655666777", correo: "elena.ruiz@example.com",
      fechaInicio: "2026-04-01", fechaFin: "2027-04-01", renovado: false, nuevaFechaFin: "",
      empadronado: true, renta: 620, fianzaImporte: 620, fechaPagoFianza: "2026-04-01", fechaDevolucionFianza: "",
      observaciones: "", activo: true,
      pagos: pagosCompletos(["2026-04","2026-05","2026-06","2026-07","2026-08"]),
      documentosContrato: [], documentosIdentidad: [],
    },
    // Inquilino ya salido, para que el Histórico no esté vacío
    {
      id: "demo-historico-1", habitacion: "B1", vivienda: "",
      nombre: "Carlos", apellidos: "Navarro Díaz", tipoDocumento: "DNI", numeroDocumento: "41122334F",
      nacionalidad: "Española", telefono: "600111222", correo: "carlos.navarro@example.com",
      fechaInicio: "2025-06-01", fechaFin: "2026-06-01", renovado: false, nuevaFechaFin: "",
      empadronado: false, renta: 330, fianzaImporte: 330, fechaPagoFianza: "2025-06-01", fechaDevolucionFianza: "2026-06-05",
      observaciones: "Salió puntual, sin incidencias.", activo: false,
      pagos: pagosCompletos(["2025-06","2025-07","2025-08","2025-09","2025-10","2025-11","2025-12","2026-01","2026-02","2026-03","2026-04","2026-05"]),
      documentosContrato: [], documentosIdentidad: [],
    },
  ];
}
...
function buildDemoIncidencias() {
  return [
    {
      id: "demo-inc-1", titulo: "Grifo de la cocina gotea", descripcion: "Gotea desde hace unos días, cada vez con más fuerza.",
      habitacion: "B2", categoria: "Fontanería", estado: "abierta",
      fechaCreacion: "2026-08-20", fechaCierre: "",
      presupuestoImporte: 45, presupuestoDoc: null,
    },
    {
      id: "demo-inc-2", titulo: "Enchufe del salón no funciona", descripcion: "",
      habitacion: "Zona común", categoria: "Electricidad", estado: "en_curso",
      fechaCreacion: "2026-08-12", fechaCierre: "",
      presupuestoImporte: "", presupuestoDoc: null,
    },
    {
      id: "demo-inc-3", titulo: "Pintura desconchada en el pasillo", descripcion: "",
      habitacion: "Piso Malecón", categoria: "Pintura", estado: "cerrada",
      fechaCreacion: "2026-07-05", fechaCierre: "2026-07-18",
      presupuestoImporte: 120, presupuestoDoc: null,
    },
  ];
}

function buildDemoExpenses() {
  const mesSimple = (ibi, comunidad, luz, agua) => ({ ibi, comunidad, luz, agua, gas: 0, limpieza: 0, internet: 0 });
  return {
    "2026-05": mesSimple(0, 0, 60, 25),
    "2026-06": mesSimple(0, 0, 65, 28),
    "2026-07": mesSimple(0, 0, 70, 30),
    "2026-08": {
      luz: { "": 22, "Piso Malecón": 48, "Piso Ronda Sur": 40 },
      agua: { "": 9, "Piso Malecón": 19, "Piso Ronda Sur": 16 },
      gas: { "": 0, "Piso Malecón": 15, "Piso Ronda Sur": 0 },
      limpieza: { "": 0, "Piso Malecón": 0, "Piso Ronda Sur": 0 },
      internet: { "": 30, "Piso Malecón": 35, "Piso Ronda Sur": 32 },
      ibi: { "": 0, "Piso Malecón": 32, "Piso Ronda Sur": 28 },
      comunidad: { "": 0, "Piso Malecón": 55, "Piso Ronda Sur": 0 },
      reparacionesItems: [
        { id: "demo-rep-1", concepto: "Fontanería", importe: 45, vivienda: "" },
      ],
      otrosItems: [],
    },
    _settings: {
      modo: "porcentaje", porcentaje: 15, fijo: 0,
      arrendadorNombre: "Ana Martínez Soler", arrendadorDocumento: "12345678A",
      arrendadorDomicilio: "Calle Mayor 22, 30001 Murcia", lugarFirma: "Murcia",
      direccionesVivienda: {
        "": { calle: "Calle Alcalde Gómez", numero: "12", piso: "2", letra: "B", cp: "30008", localidad: "Murcia", provincia: "Murcia", refCatastral: "1234567AB1234C0001DE" },
        "Piso Malecón": { calle: "Calle del Malecón", numero: "8", piso: "1", letra: "A", cp: "30004", localidad: "Murcia", provincia: "Murcia", refCatastral: "9876543CD9876E0002FG" },
        "Piso Ronda Sur": { calle: "Ronda Sur", numero: "45", piso: "", letra: "", cp: "30011", localidad: "Murcia", provincia: "Murcia", refCatastral: "5566778HJ5566I0003KL" },
      },
    },
  };
}
...
function AppInner() {
  ...
  function reiniciarDemo() {
    ...
    setView("dashboard");
    notify("Demo reiniciada con los datos de ejemplo originales.");
  }
  ...
  function incomeForMonthPorVivienda(ym, viviendaKey) {
    return tenants.reduce((sum, t) => {
      if ((t.vivienda || "").trim() !== viviendaKey) return sum;
  ...
  async function fetchPlantillaPersonalizadaBytes() {
    const path = expenses._settings?.plantillaContratoPath;
    if (!path) return null;
  ...
  function addRoomLabel(name) {
    ...
    const enUso = unidadesPonderadasEnUso(tenants, roomLabels, accountPlan.plan);
    if (enUso >= limite) {
  ...
  async function uploadPlantillaContrato(file) {
    if (!file.name.toLowerCase().endsWith(".docx")) {
      notify("La plantilla debe ser un archivo .docx de Word.");
      return;
    }
    try {
      const path = `${accountId}/config/plantilla_contrato_${Date.now()}_${sanitizeFileName(file.name)}`;
      const anterior = expenses._settings?.plantillaContratoPath;
      await uploadDoc(path, file);
      if (anterior) { try { await deleteDoc(anterior); } catch (e) { /* no bloqueante */ } }
      updateArrendadorConfig({ plantillaContratoPath: path, plantillaContratoNombre: file.name, plantillaContratoFecha: new Date().toISOString() });
      notify("Plantilla de contrato actualizada.");
    } catch (e) {
  ...
  async function eliminarPlantillaContrato() {
    const path = expenses._settings?.plantillaContratoPath;
    if (!path) return;
    try {
    ...
    updateArrendadorConfig({ plantillaContratoPath: "", plantillaContratoNombre: "", plantillaContratoFecha: "" });
        ...
        <div className="rg-main">
          ...
          {view === "micuenta" && (
            <MiCuentaView
              ...
              plantillaContratoNombre={expenses._settings?.plantillaContratoNombre || ""}
              onUploadPlantilla={uploadPlantillaContrato} onEliminarPlantilla={eliminarPlantillaContrato}
              viviendas={listaViviendas()}
...
function OnboardingChecklist({ totalHabitaciones, tenantsCount, arrendadorNombre, isGratis, onGoTo, onDescartar }) {
  const pasos = [
    {
      hecho: totalHabitaciones > 0,
      titulo: "Añade tu primera habitación o vivienda",
      detalle: "Ponle el nombre que prefieras — no tiene por qué ser A1, B2...",
      accion: "Ir a Habitaciones",
      onClick: () => onGoTo("habitaciones"),
    },
    {
      hecho: tenantsCount > 0,
      titulo: "Da de alta a tu primer inquilino",
      detalle: "Sus datos, su renta y su fianza quedan guardados en su ficha.",
      accion: "Ir a Inquilinos",
      onClick: () => onGoTo("inquilinos"),
    },
    {
      hecho: !!arrendadorNombre,
      titulo: "Rellena tus datos como arrendador/a",
      detalle: isGratis
        ? "Se usan para generar contratos automáticamente — disponible desde el plan Individual."
        : "Se usan para rellenar automáticamente el contrato que generes en cada ficha.",
      accion: isGratis ? "Ver planes" : "Ir a Gastos",
      onClick: () => onGoTo(isGratis ? "micuenta" : "gastos"),
      bloqueado: isGratis,
    },
  ];
    ...
    <>
      ...
      {viviendas.length > 1 && (
        <div className="rg-card" style={{ padding: 20, marginBottom: 18 }}>
          <div className="rg-section-title">Desglose por vivienda · {monthLabel}</div>
          <div style={{ overflowX: "auto" }}>
            <table className="rg-table" style={{ minWidth: 480 }}>
              <thead>
                <tr>
                  <th>Vivienda</th>
                  <th>Ingresos</th>
              ...
              <tbody>
                {["", ...viviendas].map(v => {
                  const ing = incomeForMonthPorVivienda(selectedMonth, v);
                  const ben = netProfitForMonthPorVivienda(selectedMonth, v);
                  const rent = profitabilityForMonthPorVivienda(selectedMonth, v);
                  if (v === "" && ing === 0 && ben === 0) return null;
                  return (
                    <tr key={v || "general"}>
                      <td>{v || "General (sin vivienda asignada)"}</td>
                      <td style={{ color: "var(--ok)" }}>{fmtMoney(ing)}</td>
                      <td style={{ color: ben >= 0 ? "var(--ok)" : "var(--danger)" }}>{fmtMoney(ben)}</td>
                      <td style={{ color: "var(--accent)" }}>{rent.toFixed(1)}%</td>
                    </tr>
                  );
                })}
              </tbody>
...
function RoomConfigModal({ roomLabels, tenants, onAdd, onRename, onRemove, onClose, maxUnidades, planKey }) {
  const [nuevoNombre, setNuevoNombre] = useState("");
  const [editando, setEditando] = useState(null); // nombre actual en edición
  const [valorEdicion, setValorEdicion] = useState("");
  const enUsoPonderado = unidadesPonderadasEnUso(tenants, roomLabels, planKey);
  const alLimite = enUsoPonderado >= maxUnidades;
  const hayViviendas = tenants.some(t => t.vivienda && t.vivienda.trim());

  function handleAdd() {
    if (onAdd(nuevoNombre)) setNuevoNombre("");
  }
  ...
  return (
    <div className="rg-modal-overlay" onClick={onClose}>
      <div className="rg-modal" style={{ maxWidth: 480 }} onClick={(e) => e.stopPropagation()}>
        <div className="rg-modal-title" style={{ marginBottom: 4 }}>Configurar unidades</div>
        <div style={{ fontSize: 12.5, color: "var(--text-dim)", marginBottom: 4 }}>
          Añade, renombra o quita las habitaciones o viviendas que gestionas — no tienen por qué
          llamarse A1, B2... ponles el nombre que prefieras.
        </div>
        ...
        {hayViviendas && (
          <div style={{ fontSize: 11, color: "var(--text-dim)", marginBottom: 16 }}>
            Cada vivienda completa (asignada en la ficha del inquilino) cuenta como varias
            habitaciones sueltas, según tu plan.
          </div>
        )}
              ...
              <div key={label} style={{ display: "flex", alignItems: "center", gap: 8, background: "var(--bg)", border: "1px solid var(--border)", borderRadius: 8, padding: "8px 10px" }}>
                {editando === label ? (
                  ...
                  <>
                    ...
                    <button
                      className="rg-icon-btn" title={enUso ? "Libera la habitación antes de quitarla" : "Quitar"}
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 8 }}>
          <input
            className="rg-input" placeholder="Ej. Ático, Local 3, Vivienda Norte..." value={nuevoNombre}
...
function HabitacionesView({ tenants, selectedMonth, onEdit, onFree, onAddForRoom, roomLabels, onAddRoom, onRenameRoom, onRemoveRoom, maxUnidades, planKey, isGratis }) {
...
function unidadesPonderadasEnUso(tenants, roomLabels, planKey) {
...
function MiCuentaView({ accountPlan, roomLabels, tenants, session, onSignOut, onGoToHabitaciones, onExportarCopia, onEliminarCuenta, eliminandoCuenta, arrendadorConfig, updateArrendadorConfig, plantillaContratoNombre, onUploadPlantilla, onEliminarPlantilla, viviendas, getDireccionVivienda, updateDireccionVivienda }) {
  ...
  const unidadesUsadas = Math.round(unidadesPonderadasEnUso(tenants, roomLabels, accountPlan.plan) * 10) / 10;
  const limite = accountPlan.max_unidades ?? 3;
  ...
  return (
    <>
      ...
      <div className="rg-card" style={{ padding: 20, marginBottom: 18 }}>
        ...
        {viviendas.length <= 1 ? (
          ...
          <>
            ...
            <div style={{ fontSize: 11.5, color: "var(--text-dim)", marginTop: -6, marginBottom: 12 }}>
              Tienes varias viviendas dadas de alta — cada una necesita su propia dirección y
              referencia catastral para que los contratos salgan correctos.
            </div>
            {viviendas.map(v => (
        ...
        <div className="rg-section-title" style={{ marginTop: 20 }}>Plantilla de contrato</div>
        <div style={{ fontSize: 12, color: "var(--text-dim)", marginBottom: 12 }}>
          Por defecto, "Generar contrato" usa la plantilla estándar de Susalquia con los datos de arriba. Si
          prefieres usar tu propio modelo de contrato en Word, súbelo aquí — debe contener las mismas
          etiquetas (por ejemplo <code className="rg-mono">@@NOMBRE_COMPLETO@@</code>) donde quieras que se
          rellenen los datos automáticamente.
        </div>
        {plantillaContratoNombre ? (
          <div className="rg-factura-row">
            <span className="rg-chip"><FileText size={11} /> {plantillaContratoNombre}</span>
            <button type="button" className="rg-icon-btn" onClick={onEliminarPlantilla} title="Quitar y volver a la plantilla estándar">
              <Trash2 size={13} />
            </button>
          </div>
        ) : (
        ...
        <label className="rg-btn rg-btn-ghost" style={{ display: "inline-flex", marginTop: 8, cursor: "pointer" }}>
          <Upload size={13} /> {plantillaContratoNombre ? "Sustituir plantilla" : "Subir mi propia plantilla (.docx)"}
          <input
            type="file" accept=".docx" style={{ display: "none" }}
            onChange={(e) => { if (e.target.files[0]) onUploadPlantilla(e.target.files[0]); e.target.value = ""; }}
          />
        </label>
      </div>
...
function TenantFormModal({ tenant, onCancel, onSave, notify, onViewDoc, arrendadorConfig, getDireccionVivienda, onGetPlantillaBytes, accountId, isGratis, selectedMonth }) {
  ...
  async function handleGenerarContrato() {
    ...
    const direccionVivienda = getDireccionVivienda((form.vivienda || "").trim());
    ...
    try {
      const plantillaBytes = onGetPlantillaBytes ? await onGetPlantillaBytes() : null;
      await generarContratoDocx(form, arrendadorConfig, direccionVivienda, plantillaBytes);
    ...
    <div className="rg-modal-overlay" onClick={onCancel}>
      <div className="rg-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="rg-form-grid">
          ...
          <div className="rg-field">
            <label className="rg-label">Vivienda (opcional)</label>
            <input className="rg-input" value={form.vivienda} onChange={(e) => set("vivienda", e.target.value)} placeholder="Ej. Piso Alicante" />
            <div style={{ fontSize: 11, color: "var(--text-dim)", marginTop: 4 }}>
              Solo si gestionas varias viviendas completas — así puedes ver ingresos y gastos por
              separado en cada una. Si no te aplica, déjalo en blanco.
            </div>
          </div>
          <div className="rg-field">
