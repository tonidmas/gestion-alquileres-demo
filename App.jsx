...
function AppInner() {
  ...
  const [contratoGeneradoAlgunaVez, setContratoGeneradoAlgunaVez] = useState(false);
  ...
  function reiniciarDemo() {
    ...
    setContratoGeneradoAlgunaVez(false);
    setView("dashboard");
    ...
    <div className="rg-root">
      ...
      {showForm && editingTenant && (
        <TenantFormModal
          ...
          onContratoGenerado={() => setContratoGeneradoAlgunaVez(true)}
        />
      )}
...
function OnboardingChecklist({ totalHabitaciones, tenantsCount, arrendadorNombre, direccionViviendaRellena, contratoGeneradoAlgunaVez, hayGastosIntroducidos, isGratis, onGoTo, onDescartar }) {
  const pasos = [
    {
    ...
    },
    {
      ...
      detalle: "Dirección y referencia catastral — también hacen falta para el contrato.",
      accion: "Ir a Mi cuenta",
      onClick: () => onGoTo("micuenta"),
    },
    {
    ...
    },
    {
      ...
      accion: isGratis ? "Ver planes" : "Ir a Habitaciones",
...
function TenantFormModal({ tenant, onCancel, onSave, notify, onViewDoc, arrendadorConfig, getDireccionVivienda, onGetPlantillaBytes, accountId, isGratis, selectedMonth, onContratoGenerado }) {
